...
# ..............system task.................
    ...
    if "speed test" in text:
        speak("starting a speed test")
        speed_test = speedtest.Speedtest()
        dowload = round(speed_test.download(), 2)
        upload = round(speed_test.upload(), 2)
        speak(f'The internet have {dowload} bit per second downloading speed and {upload} bit per second uploading speed')
